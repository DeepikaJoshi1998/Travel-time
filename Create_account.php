...
<div class="signup-form">
    <form action="pro_Create_account.php" method="get">
        ...
        <div class="form-group">
        	<input type="text" class="form-control input-lg" name="Name" placeholder="Username" required="required">
        </div>
		<div class="form-group">
		...
		<div class="form-group">
            <input type="text" class="form-control input-lg" name="Phone_number" placeholder="Phone number" required="required">
        </div>  
        <div class="form-group">
